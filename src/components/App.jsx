                ...
                <ul className="navbar-nav ml-auto">
                    ...
                    <li className="nav-item dropdown no-arrow">
                        <a className="nav-link dropdown-toggle" href="/" id="userDropdown">
                            ...
                            <img className="img-profile rounded-circle" src="assets/images/dummy-avatar.jpg" width="60" alt = 'lastproduct'/>
                        </a>
                    </li>
                        ...
                        <div className="card shadow mb-4">
                            ...
                            <div className="card-body">
                                <div className="text-center">
                                    <img className="img-fluid px-3 px-sm-4 mt-3 mb-4" style={style} src="assets/images/product_dummy.svg" alt="dummy"/>
                                </div>
